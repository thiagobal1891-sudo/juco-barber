  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400">Vaon Studio — Gestión Integral</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#111] border border-white/5 rounded-3xl p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-white">Próximos Turnos</h2>
            <Link href="/admin/agenda" className="text-sm text-amber-500 hover:text-amber-400 font-bold transition-colors">Ver agenda completa</Link>
          </div>
          
          <div className="space-y-4">
            {bookings?.filter(b => b.status === 'reserved' && new Date(b.startTime) > new Date()).slice(0, 5).map((booking) => (
